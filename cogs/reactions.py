...
class RoleReactClient(discord.Client):
    def __init__(self, *args, **kwargs):
        ...
        self.emoji_to_role = {
            GreenTick~1: 808388285989650530,  # ID of role associated with partial emoji object 'partial_emoji_1'
            RedCheck: 808388285989650525  # ID of role associated with partial emoji object 'partial_emoji_2'
        }
